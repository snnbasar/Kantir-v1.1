...
public class PickUpController : MonoBehaviour
{
    ...
    private void Update()
    {
        if (player)
        {
            ...
            if (!equipped && distanceToPlayer.magnitude <= pickUpRange && Input.GetKeyDown(KeyCode.E) && !playerStats.slotFull && ownerName == "") PickUp();

            //Drop if equipped and "Q" is pressed
            if (equipped && Input.GetKeyDown(KeyCode.Q) && ownerName == localPlayerName) Drop();
        }
    }
